        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <a href="/pengabdian/create"><input type="submit" value="TAMBAH DATA" class="btn btn-success float-right"></a><br><br>
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                <a class="btn btn-info btn-sm" href="/pengabdian/{{$n->id}}/edit">
                                        Edit
                                    </a>
                                    <form action="/pengabdian/{{$n->id}}" method="POST">
                                        @csrf
                                        @method('delete')
